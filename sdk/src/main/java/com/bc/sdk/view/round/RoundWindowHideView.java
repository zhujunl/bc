...
public class RoundWindowHideView extends LinearLayout {
    ...
    public static RoundWindowHideView instance;

    public static RoundWindowHideView getInstance(Context context, ClickListener click) {
        if (instance == null) {
            instance = new RoundWindowHideView(context, click);
        }
        return instance;
    }
